                        ...
                        popup: function(item, isByActions) {
                            ...
                            var container = $(n.thumbnails.popup.container),
                                ...
                                renderPopup = function() {
                                    ...
                                    // popup arrows
                                    var arrows = item.popup.html.find('[data-action="prev"], [data-action="next"]').show();
                                    if (f._itFl.length == 1)
                                        arrows.hide();
                                    if (!n.thumbnails.popup.arrows) {
                                        arrows.remove();
                                    } else if(!n.thumbnails.popup.loop) {
                                        arrows.show();
